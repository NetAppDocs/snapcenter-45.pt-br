...
As configurações compatíveis com o plug-in SnapCenter para banco de dados Oracle estão listadas na https://mysupport.netapp.com/matrix/imt.jsp?components=100747;&solution=1257&isHWU&src=IMT["Ferramenta de Matriz de interoperabilidade do NetApp"^].
