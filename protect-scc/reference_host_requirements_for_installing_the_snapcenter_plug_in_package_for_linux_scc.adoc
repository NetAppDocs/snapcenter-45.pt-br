...
|===
Para obter as informações mais recentes sobre versões suportadas, consulte a. https://mysupport.netapp.com/matrix/imt.jsp?components=100747;&solution=1257&isHWU&src=IMT["Ferramenta de Matriz de interoperabilidade do NetApp"]
